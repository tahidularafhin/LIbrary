...
namespace LibraryServices
{
    public class CheckoutService : ICheckout
    {
        ...
        public void CheckInItem(int assetId)
        {
            ...
            // if there are holds , checkout item to the library card
            ...
            UpdateAssetStatus(assetId, "Avilable");
            _context.SaveChanges();
        ...
        public void CheckOutItem(int assetId, int librarayCardId)
        {
            ...
            var libraryCard = _context.LibraryCards
                ...
                .FirstOrDefault(card => card.Id == librarayCardId);
        ...
        public bool IsCheckedOut(int assetId) //its can be change public
        {
            return
                _context.Checkouts
        ...
        public IEnumerable<CheckoutHistory> GetCheckoutsHistory(int id)
        {
        ...
        public string GetCurrentHoldPatronName(int holdId)
        {
            ...
            return patron?.FirstName + " " + patron?.LastName; //ekane Patron er p maybe small letter hobe
        }
